...
import AgentStatsTiles from './agents/AgentStatsTiles';
      ...
      <body>
        <div class="header-container">
          ...
          <div class="header-left">
            ...
            <p>مرجع السند: TELE/AGENTS-2026-${((globalThis.crypto.getRandomValues(new Uint32Array(1))[0] % 10000)).toString().padStart(4, '0')}</p>
          </div>
        </div>
