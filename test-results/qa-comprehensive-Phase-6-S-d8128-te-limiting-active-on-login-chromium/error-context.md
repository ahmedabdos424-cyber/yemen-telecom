...
- Name: qa-comprehensive.spec.cjs >> Phase 6: Security Testing (Production) >> Rate limiting active on login
- Location: qa-tests\qa-comprehensive.spec.cjs:150:3
...
Expected value: 429
Received array: [400, 400, 400, 400, 400, 400, 400, 400, 400, 400, …]
```
